...
class UNET(nn.Module):
    ...
    def forward(self, X):
        ...
        enc1 = self.enc1(X)
        enc2 = self.enc2(F.max_pool2d(enc1, kernel_size=(2,2), stride=2))
        enc3 = self.enc3(F.max_pool2d(enc2, kernel_size=(2,2), stride=2))
        enc4 = self.enc4(F.max_pool2d(enc3, kernel_size=(2,2), stride=2))


        res1 = self.dec1(F.max_pool2d(enc4, kernel_size=(2,2), stride=2))
